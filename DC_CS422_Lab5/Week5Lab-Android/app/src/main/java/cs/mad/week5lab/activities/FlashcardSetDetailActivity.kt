...
import cs.mad.week5lab.entities.*
...
class FlashcardSetDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        runOnIO { flashcards =  flashcardDao.getAll()}
    ...
    fun addFlashcard(view: View) {
        ...
        val flashcard = Flashcard("New Term","New Definition",null)
        adapter.add(flashcard, applicationContext)
